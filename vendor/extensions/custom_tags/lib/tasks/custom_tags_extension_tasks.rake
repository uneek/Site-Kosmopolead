  ...
  namespace :extensions do
    namespace :custom_tags do
      ...
      task :update => :environment do
        ...
        puts "Copying assets from CustomTagsExtension"
        ...
        unless CustomTagsExtension.root.starts_with? RAILS_ROOT # don't need to copy vendored tasks
          puts "Copying rake tasks from CustomTagsExtension"
          local_tasks_path = File.join(RAILS_ROOT, %w(lib tasks))
          mkdir_p local_tasks_path, :verbose => false
          Dir[File.join CustomTagsExtension.root, %w(lib tasks *.rake)].each do |file|
      ...
      task :sync => :environment do
        ...
        language_root = CustomTagsExtension.root + "/config/locales"
